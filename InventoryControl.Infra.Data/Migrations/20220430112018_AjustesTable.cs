...
namespace InventoryControl.Infra.Data.Migrations
{
    ...
    public partial class AjustesTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO [dbo].[Usuario]([Login],[Senha],[CpfCnpj],[Nome],[Email],[DataNascimento],[PerfilUsuarioId],[Situacao])VALUES('admin' , 'admin@123' , null , 'admin', 'admin@devscansados.com', '2022-01-01', (SELECT TOP(1) Id FROM PerfilUsuario WHERE Nome = 'ADMIN'),  1)");
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("DELETE FROM Usuario WHERE Login = 'admin'");
